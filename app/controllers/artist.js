...
export default Ember.Controller.extend({
  ...
  actions: {
    generatePlaylist(){
        ...
        //var playlistName=this.get('playlistName');
        //console.log("playlistName is: " + playlistName);
        //var Spotify = require('bower_components/spotify-web-api-js/src/spotify-web-api.js');
        ...
        s.searchTracks('Love')
          .then(function(data) {
            self.set('result', data.tracks.items.objectAt(0).name);

            console.log('Search by "Love"', data.tracks.items.objectAt(0).name);
          }, function(err) {
            console.error(err);
          });
        ...
        //create playlist with playlistName

        //add top 5 songs of artist to that playlist
